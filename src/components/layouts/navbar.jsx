...
const Navbar = () => {
  return (
    <nav className="fixed z-50 bg-white w-full py-2 h-16 flex flex-row justify-between items-center">
      <img className='absolute w-full h-full object-cover' src="/assets/images/main/bg-nav.png" alt="" />
      {/* bagian logo */}
